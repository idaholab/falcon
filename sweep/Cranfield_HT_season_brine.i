...
#  fp = tabulated_water
  ...
  use_brine = true
  nacl_index = 0
  mass_fraction_vars = mass_frac_nacl
[]
...
[Variables]
  ...
  [../]
  [./mass_frac_nacl]
  #  initial_condition = ${salinity_ini_bc}
  [../]
[]
###########################################################
[AuxVariables]
...
[ICs]
  [./init_nacl]
    type = FunctionIC
    function = ${salinity_ini_bc}
    variable = mass_frac_nacl
  [../]
  [./init_pp]
    type = FunctionIC
    function = ${pp_ini_bc}
...
[Functions]
  ...
  [./rest_function]
    type = ParsedFunction
    value = '((t/24/3600/365-floor(t/24/3600/365))>0.25 & (t/24/3600/365-floor(t/24/3600/365)) <= 0.5) | ((t/24/3600/365-floor(t/24/3600/365)) > 0.75)'
  [../]
[]
############################################################
[Modules]
