...
_darcy_energy_flux_water(getMaterialProperty<RealGradient>("darcy_energy_flux_water")), 
_darcy_mass_flux_water(getMaterialProperty<RealGradient>("darcy_mass_flux_water")),
_darcy_energy_flux_steam(getMaterialProperty<RealGradient>("darcy_energy_flux_steam")),
...
OutFlowBC_PH::computeQpResidual()
{
    ...
    ( _thermal_conductivity[_qp] *(_grad_T[_qp]*_normals[_qp])
     + _darcy_energy_flux_water[_qp]* _normals[_qp]
     + _darcy_energy_flux_steam[_qp]*_normals[_qp]);
