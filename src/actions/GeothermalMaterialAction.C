...
GeothermalMaterialAction::act()
{
    ...
    if (_pars.isParamValid("x_disp"))
    {
        ...
        //NonlinearVariableName x_var = getParam<NonlinearVariableName>("x_disp");
        //shared_params.set<NonlinearVariableName>("x_disp") = x_var;
    }
    if (_pars.isParamValid("y_disp"))
    {
        ...
        //NonlinearVariableName y_var = getParam<NonlinearVariableName>("y_disp");
        //shared_params.set<NonlinearVariableName>("y_disp") = y_var;
    }
    if (_pars.isParamValid("z_disp"))
    {
        ...
        //NonlinearVariableName z_var = getParam<NonlinearVariableName>("z_disp");
        //shared_params.set<NonlinearVariableName>("z_disp") = z_var;
    }
