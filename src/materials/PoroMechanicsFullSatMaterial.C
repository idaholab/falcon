...
#include "PoroMechanicsFullSatMaterial.h"

registerMooseObject("FalconApp", PoroMechanicsFullSatMaterial);

InputParameters
PoroMechanicsFullSatMaterial::validParams()
{
...
PoroMechanicsFullSatMaterial::PoroMechanicsFullSatMaterial(const InputParameters & parameters)
...
void
PoroMechanicsFullSatMaterial::initQpStatefulProperties()
{
  _vol_strain[_qp] = 0.0;
}

void
PoroMechanicsFullSatMaterial::computeQpProperties()
{
