...
FluidFlow2Phase::FluidFlow2Phase(std::string name,
  ...
  :PorousMedia(name, moose_system, parameters),
   ...
   //delcare material properties
     ...
     _rho_s(declareRealProperty("rho_s")),
     _rho_mix(declareRealProperty("rho_mix")),
     _c_f(declareRealProperty("c_f")),
     _mu_w(declareRealProperty("mu_w")),
     _mu_s(declareRealProperty("mu_s")),
     _rel_perm_w(declareRealProperty("rel_perm_w")),
     _rel_perm_s(declareRealProperty("rel_perm_s")),
   //  _temp(declareRealProperty("tempMat")),
   // _temp_old(declareRealPropertyOld("tempMat")),
     _sat_w(declareRealProperty("sat_w")),
     _sat_s(declareRealProperty("sat_s")),
     _dTbydP_H(declareRealProperty("dTbydP_H")),
     _dTbydH_P(declareRealProperty("dTbydH_P")),
     _sat_enthalpy_w(declareRealProperty("sat_enthalpy_w")),
     _sat_enthalpy_s(declareRealProperty("sat_enthalpy_s")),
     _darcy_params_w(declareRealProperty("darcy_params_w")),
     _darcy_params_s(declareRealProperty("darcy_params_s")),
     _darcy_flux_w(declareGradientProperty("darcy_flux_w")),
     _darcy_flux_s(declareGradientProperty("darcy_flux_s")),
     _pore_velocity_w(declareGradientProperty("pore_velocity_w")),
     _pore_velocity_s(declareGradientProperty("pore_velocity_s"))
{ }
