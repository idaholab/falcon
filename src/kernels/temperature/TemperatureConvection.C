...
Real TemperatureConvection::computeQpResidual()
{
 ...
 return _specific_heat_water[_qp]*_darcy_flux_water[_qp]*_density_water[_qp]*_test[_i][_qp]*_grad_u[_qp];
...
//   return _darcy_flux_water_w[_qp]*_phi[_i][_qp]*_dphi[_j][_qp];
   return _specific_heat_water[_qp]*_darcy_flux_water[_qp]*_density_water[_qp]*_test[_i][_qp]*_grad_phi[_j][_qp];
