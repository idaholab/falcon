...
SolidMechPoroCoupleY::SolidMechPoroCoupleY(std::string name, MooseSystem & moose_system, InputParameters parameters)
...
{
  return -_dphi[_i][_qp](1)*_biot_coeff[_qp]*_pressure_val[_qp];
...
//      return _phi[_i][_qp]*_biot_coeff[_qp]*_dphi[_j][_qp](1);
    return  -_dphi[_i][_qp](1)*_biot_coeff[_qp]*_dphi[_j][_qp](1);
  return 0.0;
}
