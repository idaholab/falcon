...
SolidMechPoroCoupleZ::SolidMechPoroCoupleZ(const std::string & name, MooseSystem & moose_system, InputParameters parameters)
...
//    return _phi[_i][_qp]*_biot_coeff[_qp]*_grad_pressure[_qp](2);
  return -_grad_phi[_i][_qp](2)*_biot_coeff[_qp]*_pressure_val[_qp];
}
...
//      return _phi[_i][_qp]*_biot_coeff[_qp]*_dphi[_j][_qp](2);
    return  -_grad_phi[_i][_qp](2)*_biot_coeff[_qp]*_grad_phi[_j][_qp](2);
  return 0.0;
}
