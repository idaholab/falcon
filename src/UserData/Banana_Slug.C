...
Banana_Slug::Banana_Slug(const std::string & name, InputParameters params) :
    UserObject(name, params)
{ }

Banana_Slug::~Banana_Slug()
{ }
...
Real Banana_Slug::phase_determ(Real _enth_in, Real _press_in, Real& _phase, Real& _temp_sat, Real& _enth_water_sat, Real& _enth_steam_sat, Real& _dens_water_sat, Real& _dens_steam_sat) const
{
    ...
    ///////////only acurate for temperatures below 350 C, pressures below 100 MPa, and enthalpies below 2.6 MJ/kg
...
Real Banana_Slug::water_eq_of_state(Real _enth_in, Real _press_in, Real _temp_sat, Real& _temp1, Real& _dens1, Real& _enth1) const
{   
    //Variables:
    Real C_to_K = 273.15e0;                                     //Convertion factor from Celcius to Kelvin *formerly tc_k
...
Real Banana_Slug::steam_eq_of_state(Real _enth_in, Real _press_in, Real _temp_sat, Real& _temp2, Real& _dens2, Real& _enth2) const
{   //Variables:
    Real C_to_K = 273.15e0;                                     //Convertion factor from Celcius to Kelvin *formerly tc_k
...
Real Banana_Slug::viscosity(Real _density, Real _temp, Real& _viscosity) const
{   
...
Real Banana_Slug::water_EOS_deriv_init_values(Real _press_in, Real _temp_0, Real& _enth_water_0, Real& _dens_water_0) const
{
    //Variables:
    Real C_to_K = 273.15e0;                                         //Convertion factor from Celcius to Kelvin *formerly tc_k
    Real temp_kelvin;                                               //temperature converted to kelvin
...
Real Banana_Slug::steam_EOS_deriv_init_values(Real _press_in, Real _temp_0, Real& _enth_steam_0, Real& _dens_steam_0) const
{ 
    //Variables:
    Real C_to_K = 273.15e0;                                         //Convertion factor from Celcius to Kelvin *formerly tc_k
    Real temp_kelvin;                                               //temperature converted to kelvin
...
//Banana_Slug: phase_determ, water_eq_of_state, steam_eq_of_state, and viscosity functions are callsed whithin the above function.
...
Real Banana_Slug::Equations_of_State_Derivative_Properties(Real _enth_in, Real _press_in, Real& _temp_out, Real& _sat_fraction_out, Real& _dens_out, Real& _dens_water_out, Real& _dens_steam_out, Real& _enth_water_out, Real& _enth_steam_out, Real& _visc_water_out, Real& _visc_steam_out, Real& _del_press, Real& _del_enth, Real& _d_enth_water_d_press, Real& _d_enth_steam_d_press, Real& _d_dens_d_press, Real& _d_temp_d_press, Real& _d_enth_water_d_enth, Real& _d_enth_steam_d_enth, Real& _d_dens_d_enth, Real& _d_temp_d_enth, Real& _d_sat_fraction_d_enth) const
{
    ...
    //Real _d_temp_d_press;                        //*formerly dTdp - derivative of temperature w.r.t. pressure
    //Real _d_enth_water_d_press;                  //*formerly dhwdp - derivative of water enthalpy w.r.t. pressure
    //Real _d_enth_steam_d_press;                  //*formerly dhsdp - derivative of steam enthalpy w.r.t. pressure
    //Real _d_dens_d_press;                        //*formerly dDendp - derivative of density w.r.t. pressure
    //derivatives with respect to enthalpy:
    //Real _d_temp_d_enth;                         //*formerly dTdh - derivative of temperature w.r.t. enthalpy
    //Real _d_enth_water_d_enth;                   //*formerly dhwdh - derivative of water enthalpy w.r.t. enthalpy
    //Real _d_enth_steam_d_enth;                   //*formerly dhsdh - derivative of steam enthalpy w.r.t. enthalpy
    //Real _d_dens_d_enth;                         //*formerly dDendh - derivative of density w.r.t. enthalpy
    //Real _d_sat_fraction_d_enth;                 //*formerly dswdh - derivative of saturation fraction w.r.t. enthalpy
...
//Banana_Slug: Equations_of_State_Properties, phase_determ, water_eq_of_state, steam_eq_of_state, water_EOS__deriv_init_values, 
//and steam_EOS_deriv_init_values are called within the above funtion.  This allows for more organization and flexibility.  
