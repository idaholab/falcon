...
#ifndef FRACMANFLUIDFLOW_H
#define FRACMANFLUIDFLOW_H
 ...
 */
class FracManFluidFlow : virtual public FracManPorousMedia
{
public:
  FracManFluidFlow(const std::string & name,
