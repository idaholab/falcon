...
[Reporters]
  ...
  [pt_frac_out]
    type = ConstantReporter
    real_vector_names = 'xcoord1 ycoord1 zcoord1 xcoord2 ycoord2 zcoord2'
    real_vector_values = '${x1_out}; ${y1_out}; ${z1_out}; ${x2_out}; ${y2_out}; ${z2_out}'
    outputs = none #var_all
  []
  [node_frac_in]
    type = ConstantReporter
...
[MultiApps]
  [fracture_app]
    ...
    input_files = frac_app_lineSource.i
