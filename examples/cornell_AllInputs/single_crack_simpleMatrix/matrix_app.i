...
[Variables]
  [matrix_P]
    # scaling = 1E6  #fixme using autoscaling in executioner
  []
  [matrix_T]
...
[BCs]
  [./pore_pressure_top]
    ...
    variable = matrix_P
    boundary = 5
    value = 20  #fixme lynn I don't konw what this is,
                #is it hydrostatic pressure and should change with depth?
  [../]
  [./temperature_top]
