...
[DiracKernels]
  ...
  [withdraw_fluid]
    ...
    #fixme is I think this is 1MPa over hydrostatic pressure at 3km
    bottom_p_or_t = 30.6 #10.6 # 1MPa + approx insitu at production point, to prevent aperture closing due to low porepressures
    character = 1
    line_length = 1
  ...
  [withdraw_heat]
    ...
    #fixme is I think this is 1MPa over hydrostatic pressure at 3km
    #fixme  should this be pressure?  this Peaceman is for Temperature.
    bottom_p_or_t = 30.6 #10.6 # 1MPa + approx insitu at production point, to prevent aperture closing due to low porepressures
    character = 1
    line_length = 1
    point_file = production.xyz
