...
[Mesh]
  ...
  [cluster34]
    ...
    file = Cluster_output_vtxprops_2.e # 'Cluster_34.exo'
  []
  [injection_node]
...
[AuxKernels]
  [./FILE_nodal_pres]
    ...
    variable = FILE_nodal_pres
    from_variable = nodal_pres
  [../]
  [./FILE_nodal_aper]
    type = SolutionAux
    solution = solution_uo
    variable = FILE_nodal_aper
    from_variable = nodal_aper
  [../]
  [./FILE_BlockIndex]
    type = SolutionAux
    solution = solution_uo
    variable = FILE_BlockIndex
    from_variable = BlockIndex
  [../]
  [./FILE_cell_aper]
    type = SolutionAux
    solution = solution_uo
    variable = FILE_cell_aper
    from_variable = cell_aper
  [../]
  [normal_dirn_x_auxk]
...
[UserObjects]
  #this reads the solution values from an exodus mesh
  [./solution_uo]
    type = SolutionUserObject
    mesh = 'Cluster_output_vtxprops_2.e'
    timestep = 'LATEST'
    execute_on = 'INITIAL'
    system_variables = 'nodal_pres nodal_aper BlockIndex cell_aper'
  [../]
  [kg_out_uo]
