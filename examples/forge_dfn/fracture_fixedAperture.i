...
[Mesh]
  ...
  [inputDFN]
    ...
    # file = 'Simple_Cubit.e'
    file = 'Model_28N_No_DFN_mesh.exo'
  []
  [injection_node]
    type = BoundingBoxNodeSetGenerator
    input = inputDFN
    bottom_left = '-300 -1 -421'
    top_right = '-299 0 -420'
    new_boundary = injection_node
    #Node         236  -2.999510385E+02  -6.780877763E-01  -4.209609994E+02
  []
[]
...
[DiracKernels]
  [inject_fluid]
    ...
    mass_flux = injectionFunc
    point = '-2.999510385E+02  -6.780877763E-01  -4.209609994E+02'    #Node         236  -2.999510385E+02  -6.780877763E-01  -4.209609994E+02
    variable = frac_P
  []
  [withdraw_fluid]
...
[Functions]
  [injectionFunc]
      ...
      x = '0 100     1e8'
      y = '0.1 ${injection_rate} ${injection_rate}'
  []
  [kg_rate]
    type = ParsedFunction
    vals = 'dt kg_out'
...
[Postprocessors]
  ...
  #   type = PointValue
  #   variable = frac_T
  #   point = '-299.952960 -55.315024 -327.949995'
  # []
  # [P_out]
  #   type = PointValue
  #   variable = frac_P
  ...
  [P_in]
    type = PointValue
    variable = frac_P
    point = '-299.951741 -3.370187 -301.124013'
  []
[]
...
[Executioner]
  ...
  []
  # fixme Rob told me to try this.  The system doesn't change much once it is pressurized so the residual can't change much either
  steady_state_detection = true
  steady_state_start_time = 20000  #this should start after the system has pressurized
  steady_state_tolerance = 1e-6   #fixme should be smaller than nl_resid

  dtmin = 0.1
  dtmax = 1000 #courant condition Peclet(?) number (advection versuss diffusion)
  end_time = 1e8
  line_search = 'none'
